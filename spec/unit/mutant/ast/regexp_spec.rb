...
# We deliberately want to assert regexp_literal_escape nodes so this cop does
# not make sense to have enabled here.
#
...
# Rubocop's corrected form mangles the regex.
