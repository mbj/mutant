...
describe Mutant::Strategy::Rspec::DM2Lookup, '#spec_file' do
  ...
  shared_examples_for 'Mutant::Strategy::Rspec::DM2Lookup#spec_file' do
  ...
  context 'negation operator' do
    ...
    it_should_behave_like 'Mutant::Strategy::Rspec::DM2Lookup#spec_file'
  end
