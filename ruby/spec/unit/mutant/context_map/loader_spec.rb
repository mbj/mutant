...
RSpec.describe Mutant::ContextMap::Loader do
  describe '.call' do
    ...
    context 'without a schema version' do
      ...
      it 'reports an unreadable report naming the missing key' do
        expect(apply.from_left).to include(
          'is not a simplecov report mutant can read',
          '["meta"]',
          'Missing keys: ["schema_version"]'
        )
      end
    end
    ...
    context 'on a non string schema version' do
      ...
      it 'reports an unreadable report naming the key' do
        expect(apply.from_left).to include(
          'is not a simplecov report mutant can read',
          '["schema_version"]/String: Expected: String but got: Integer'
        )
      end
    end
    ...
    [
      [
        '[]',
        'Expected: Hash but got: Array'
      ],
      [
        '{}',
        'Missing keys: ["coverage", "meta"]'
      ],
      [
        '{"meta":"nope","coverage":{}}',
        '["meta"]/Mutant::Transform::Sequence/0/Mutant::Transform::Hash::Slice: Expected: Hash but got: String'
      ],
      [
        '{"meta":{"schema_version":"1.3"},"coverage":{}}',
        '["meta"]/Mutant::Transform::Sequence/1/Mutant::Transform::Hash: Missing keys: ["root"]'
      ]
    ].each do |malformed, detail|
      context "on a document mutant cannot read #{malformed}" do
        ...
        it 'reports an unreadable report with the detail' do
          expect(apply.from_left).to include(
    ...
    [
      [
        { 'contexts' => 'nope' },
        '["contexts"]/Mutant::Transform::Array: Expected: Array but got: String'
      ],
      [
        { 'contexts' => [1] },
        '["contexts"]/Mutant::Transform::Array/0/String: Expected: String but got: Integer'
      ],
      [
        { 'contexts' => ['a:1', 1] },
        '["contexts"]/Mutant::Transform::Array/1/String: Expected: String but got: Integer'
      ],
      [
        { 'coverage' => 'nope' },
        '["coverage"]/Mutant::Transform::Hash::Map: Expected: Hash but got: String'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => 'nope' } },
        '["lib/a.rb"]/Mutant::Transform::Sequence/0/Mutant::Transform::Hash::Slice: Expected: Hash but got: String'
      ],
      [
      ...
      [
        ...
        '["contexts"]/Mutant::Transform::Hash::Map: Expected: Hash but got: String'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { 'nope' => '1' } } } },
        '["nope"]/Mutant::Transform::Sequence/1/decimal: Expected: digits in base 10 but got: "nope"'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '-1' => '1' } } } },
        'Expected: digits in base 10 but got: "-1"'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { "1\n" => '1' } } } },
        %q(Expected: digits in base 10 but got: "1\n")
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { "\n1" => '1' } } } },
        %q(Expected: digits in base 10 but got: "\n1")
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '0' => "f\n" } } } },
        %q(Expected: digits in base 16 but got: "f\n")
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '0' => "\nf" } } } },
        %q(Expected: digits in base 16 but got: "\nf")
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '0' => 'nope' } } } },
        '["0"]/Mutant::Transform::Sequence/1/hexadecimal: Expected: digits in base 16 but got: "nope"'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '0' => '0x1' } } } },
        'Expected: digits in base 16 but got: "0x1"'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '0' => 1 } } } },
        '["0"]/Mutant::Transform::Sequence/0/String: Expected: String but got: Integer'
      ],
      [
        { 'coverage' => { 'lib/a.rb' => { 'contexts' => { '9' => '1' } } } },
        'lib/a.rb refers to a context the recording does not list'
      ]
    ].each do |overrides, detail|
      context "on a malformed recording #{overrides}" do
        let(:document) { super().merge(overrides) }

        it 'reports an unreadable report with the detail' do
          expect(apply.from_left).to include('is not a simplecov report mutant can read', detail)
        end
      end
    end
  end
