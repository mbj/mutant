...
file in mutant's repository root.
...
Email [mbj@schirp-dso.com](mailto:mbj@schirp-dso.com).

How do I update my info?
------------------------

Email [mbj@schirp-dso.com](mailto:mbj@schirp-dso.com) with the requested changes.

Can I request a change to the license terms?
--------------------------------------------

Mutant is sold as is. Pricing becomes negotiable over 20 developers.
...
Schirp DSO LTD only collects enough customer information to provide its services which include:

* Customer data for billing purposes:
