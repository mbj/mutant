...
require 'mutant/reporter/html'
require 'mutant/reporter/html/registry'
require 'mutant/reporter/html/printer'
require 'mutant/reporter/html/report'
require 'mutant/reporter/html/report/config'
